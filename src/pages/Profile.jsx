...
const TABS = [
  ...
  { id: "children", label: "ملفات الأطفال", icon: "🧒" },
...
export default function Profile() {
  ...
  const setTab = (id) => setSearchParams(id === "info" ? {} : { tab: id });
    ...
    <AppShell>
      ...
      <div className="grid md:grid-cols-[240px_1fr] gap-6">
        ...
        <div className="space-y-6">
            ...
            <>
              ...
              <div className="bg-white rounded-xl2 border border-rawaa-gray/60 shadow-card p-6">
                ...
                <button
                  ...
                  className="mt-4 text-rawaa-ink text-sm font-semibold underline"
                >
                  ← تسجيل الخروج
                </button>
              </div>
          ...
          {tab === "children" && <ChildrenManagementPanel />}
        </div>
      </div>
    </AppShell>
  );
